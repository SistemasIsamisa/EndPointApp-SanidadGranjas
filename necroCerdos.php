...
$sql = "INSERT INTO GR_necroCerdos (fecha, granja, realizado, lote, edad, diagnostico, obs, foto1, foto2, foto3, usuario, fecha_real) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
foreach ($data as $row) {
    ...
    $params = array(
        ...
        $row['obs'], $row['foto1'], $row['foto2'], 
        $row['foto3'],$row['usuario'],$fecha
    );
