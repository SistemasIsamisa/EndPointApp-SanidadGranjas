...
$sql = "INSERT INTO GR_roedores (fecha, granja, area, galpon, ceb1, ceb2, ceb3, ceb4, ceb5, ceb6, ceb7, ceb8, ceb9, ceb10, ceb11, ceb12, producto, dosis, total, responsable, obs, usuario, fecha_real) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
foreach ($data as $row) {
    ...
    $params = array(
        ...
        $row['galpon'], $row['ceb1'], $row['ceb2'], $row['ceb3'], $row['ceb4'], $row['ceb5'], $row['ceb6'], $row['ceb7'], $row['ceb8'], $row['ceb9'], $row['ceb10'], $row['ceb11'], $row['ceb12'], 
